    ...
    public class Product : IProduct
    {
        ...
        public void AddProduct(MySqlConnection connection)
        {
            ...
            do
            {
                ...
                {
                    if (!CategoryExists(idCategory, connection))
                    {
                        CreateNewCategory(idCategory, connection);
                    }
                    break;
                }
                else Console.WriteLine("Id is not Valid (id must be numeric) .");
            ...
            string query = "INSERT INTO Product (productId,categoryID,ProductName,Price) VALUES (@productId,@categoryID,@ProductName,@Price)";
        ...
        public void FindByName(MySqlConnection connection)
        {
            ...
            string productName = Console.ReadLine();
            string query = "SELECT * FROM Product WHERE ProductName LIKE CONCAT('%', @ProductName, '%')";
        ...
        public void UpdateProduct(MySqlConnection connection)
        {
            ...
            string query = "UPDATE Product SET ProductName = @ProductName, Price = @Price WHERE ProductID = @ProductID";
            using (MySqlCommand command = new MySqlCommand(query, connection))
            {
                command.Parameters.AddWithValue("@ProductName", productName);
                command.Parameters.AddWithValue("@Price", price);
        ...
        private bool CategoryExists(int categoryId, MySqlConnection connection)
        {
        ...
        private void CreateNewCategory(int categoryId, MySqlConnection connection)
        {
